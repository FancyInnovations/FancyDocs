...
description: How to get started with FancyHolograms
---
<Callout type="error">
...
To install FancyHolograms, you need to download the latest version from one of these platforms:
- [Modrinth](https://modrinth.com/plugin/fancyholograms/versions?c=release)
- [FancySpaces](https://fancyspaces.net/spaces/fancyholograms/versions)
...
<Callout>
    You can use MiniMessages in the hologram text. For more information about MiniMessages, you can visit the [MiniMessage documentation](https://docs.papermc.io/adventure/minimessage/format/).
</Callout>