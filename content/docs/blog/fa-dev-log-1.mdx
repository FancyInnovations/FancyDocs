...
![](/blogs/fa-dev-log-1/dev-log-1.png)
...
![Metric data chart (last 6 months)](/blogs/fa-dev-log-1/metric-data-chart.png)
...
![Amount of senders chart (last 6 months)](/blogs/fa-dev-log-1/amount-senders-chart.png)
