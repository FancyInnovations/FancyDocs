...
<Callout type="info">
    This documentation is for **FancyHolograms v3** (the latest version). If you're using v2, see the [v2 documentation](./v2/getting-started.mdx).
</Callout>
...
Replace `2.9.0` with the version of the API you want to use. You can find the latest version on the download pages or in the GitHub releases.
