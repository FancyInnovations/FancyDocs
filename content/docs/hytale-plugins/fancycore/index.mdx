...
![](/logos-and-banners/fancycore-banner.png)
...
- **Placeholders**: extensive placeholder system for use in chat, scoreboard, and more
...
- **Scoreboard**: customizable scoreboard system with pages and lines
