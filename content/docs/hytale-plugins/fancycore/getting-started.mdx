...
To install FancyCore, you need to download the latest version:

<DownloadButton spaceId="fc" label="Download FancyCore" />

<Callout type="warn">
    FancyCore is currently in development. You can download snapshot versions above or keep an eye on the discord server for updates: [FancyInnovations Discord](https://discord.gg/ZUgYCEJUEx)
</Callout>
