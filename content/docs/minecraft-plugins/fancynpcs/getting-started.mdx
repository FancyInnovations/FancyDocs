...
description: Getting started with FancyNpcs
---
...
To install FancyNpcs, you need to download the latest version from one of these platforms:
- [Modrinth](https://modrinth.com/plugin/fancynpcs/versions?c=release)
- [FancySpaces](https://fancyspaces.net/spaces/fancynpcs/versions)
...
<Callout>
You can use MiniMessages in the display name to format the text. For more information about MiniMessages, you can visit the [MiniMessage documentation](https://docs.papermc.io/adventure/minimessage/format/).
</Callout>