...
<Callout type="warn">
    This action is only available if both [FancyDialogs](https://modrinth.com/plugin/fancydialogs?c=release) AND [FancyNpcs](https://modrinth.com/plugin/fancynpcs?c=release) are installed on the server.
</Callout>
