...
```kotlin
dependencies {
    compileOnly("de.oliver:FancyDialogs:1.1.0")
}
```
...
Replace `1.1.0` with the version of the API you want to use. You can find the latest version on the download pages or in the GitHub releases.
