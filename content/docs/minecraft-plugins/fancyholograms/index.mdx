...
![](/logos-and-banners/fancyholograms-banner.png)
...
All commands and features are documented in this wiki. If you have any questions, feel free to ask in the Discord server, we are happy to help you: [Join here](https://discord.gg/ZUgYCEJUEx)
...
You can download the latest version of FancyHolograms from [Modrinth](https://modrinth.com/plugin/fancyholograms/versions?c=release).
...
How to get started with FancyHolograms? Check out [this page](fancyholograms/getting-started).