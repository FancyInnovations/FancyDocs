...
![](/logos-and-banners/fancydialogs-banner.png)
...
You can download the latest version of FancyDialogs from [Modrinth](https://modrinth.com/plugin/fancydialogs/versions?c=release).
...
How to get started with FancyDialogs? Check out [this page](fancydialogs/getting-started).