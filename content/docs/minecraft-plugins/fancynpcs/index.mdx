...
![](/logos-and-banners/fancynpcs-banner.png)
...
You can download the latest version of FancyNpcs from [Modrinth](https://modrinth.com/plugin/fancynpcs/versions?c=release).
...
To get started with FancyNpcs, check out [this page](./fancynpcs/getting-started).