...
description: How to get started with FancyDialogs
---
<Callout type="error">
...
To install FancyDialogs, you need to download the latest version from one of these platforms:
- [Modrinth](https://modrinth.com/plugin/fancydialogs/versions?c=release)
- [FancySpaces](https://fancyspaces.net/spaces/fancydialogs/versions)
...
FancyDialogs uses a simple JSON format to define dialogs. Read the [JSON Schema](tutorials/json-schema) tutorial to learn more about the format.