...
![](/blogs/fa-dev-log-2/dev-log-2.png)
...
![Amount of senders chart (last 6 months)](/blogs/fa-dev-log-2/amount-senders-chart.png)
...
![Profile page](/blogs/fa-dev-log-2/navigate-to-profile.png)
