...
<Callout type="error">
    Be aware, that only Paper is supported, but the plugin should work on any of its forks (like Purpur or Pufferfish). Folia, Spigot, Bukkit, Sponge and Fabric is not supported.
</Callout>
