---
title: Action System
description: Create interactive NPCs
---
...
Administrators can add, modify, and reorder these actions using commands. (See the [commands page](../commands/npc#manage-interactions) for more details)
