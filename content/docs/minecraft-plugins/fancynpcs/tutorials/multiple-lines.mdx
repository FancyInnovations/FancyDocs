...
description: Multiple Lines as the name of a NPC
---

To have multiple lines as the display name of a NPC follow the following steps:

1. Download the [FancyHolograms](https://modrinth.com/plugin/fancyholograms/versions?c=release) plugin and put it in the `plugins`
   folder
